# Contributing to # Contributing to his-and-hers

## Getting started

```bash
git clone https://github.com/nicolasmauro/his-and-hers
cd his-and-hers
pnpm install
pnpm build
pnpm test
...
5. **# Contributing to his-and-hers
...
3. **WOL is first-class** — sleeping machines are a core use case, not an edge case
4. **Credentials in OS keychain** — never in config files or environment variables
5. **HHMessage is the protocol** — all cross-machine communication uses this envelope
...
```bash
git clone https://github.com/nicolasmauro/# Contributing to his-and-hers
...
cd # Contributing to his-and-hers
...
3. **WOL is first-class** — sleeping machines are a core use case, not an edge case
4. **Credentials in OS keychain** — never in config files or environment variables
5. **# Contributing to # Contributing to his-and-hers
